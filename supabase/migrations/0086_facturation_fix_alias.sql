-- =====================================================================
-- 0086 — Facturation : correctif bug « record l is not assigned yet »
--
-- Dans generer_factures_previsionnelles(), la sous-requête d'annulation
-- utilisait l'alias de table « l » (from public.livraison l), or « l » est
-- aussi une variable plpgsql de la fonction → conflit → la fonction échouait
-- à chaque appel et AUCUNE facture n'était générée.
-- Correctif : alias renommé en « lv ». À exécuter après 0084.
-- =====================================================================
