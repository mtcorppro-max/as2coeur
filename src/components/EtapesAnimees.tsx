...
const ETAPES = [
  ...
  },
  {
    ...
    description:
      "L'équipe échange avec le patient par messagerie sécurisée, valide les suivis planifiés. Le médecin génère et signe électroniquement les ordonnances CERFA depuis son protocole, envoyées automatiquement à la pharmacie.",
  },
  {
    icon: "truck",
