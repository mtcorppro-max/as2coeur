...
export const CONFIGS: Record<string, Conf> = {
  ...
  ald_idel_pca: {
    ...
    champs: [
      ...
      { k: "txt", key: "ampoule_mg", pos: { x: 112, y: 563 } },
      { k: "txt", key: "reservoir_ml", pos: { x: 298, y: 563 } },
      { k: "txt", key: "concentration", pos: { x: 150, y: 588 } },
      { k: "txt", key: "debit_mg_heure", pos: { x: 112, y: 632 } },
      { k: "txt", key: "debit_mg_24h", pos: { x: 230, y: 632 } },
      { k: "txt", key: "bolus_mg", pos: { x: 80, y: 660 } },
      { k: "txt", key: "interdiction_min", pos: { x: 295, y: 660 } },
      { k: "txt", key: "dose_totale_24h", pos: { x: 224, y: 707 } },
      { k: "txt", key: "ordonnance_jours", pos: { x: 130, y: 751 } },
      { k: "txt", key: "a_renouveler", pos: { x: 105, y: 767 } },
    ],
  },
  ald_idel_piccline: {
