...
export const CONFIGS: Record<string, Conf> = {
  ...
  idel_pca: {
    ...
    champs: [
      ...
      { k: "radio", key: "produit", map: { "Chlorhydrate de morphine": { x: 171, y: 508 }, "Oxynorm": { x: 336, y: 508 }, "Fentanyl": { x: 414, y: 508 } } },
      { k: "txt", key: "ampoule_mg", pos: { x: 142, y: 539 }, size: 11, centre: true },
      { k: "txt", key: "reservoir_ml", pos: { x: 335, y: 539 }, size: 11, centre: true },
      { k: "txt", key: "concentration", pos: { x: 168, y: 568 }, size: 11, centre: true },
      { k: "txt", key: "debit_mg_heure", pos: { x: 130, y: 597 }, size: 11, centre: true },
      { k: "txt", key: "debit_mg_24h", pos: { x: 252, y: 597 }, size: 11, centre: true },
  ...
  ald_perfadom_npad: {
    ...
    // masque « jours » (Ordonnances pour) + les deux « jours/7. » imprimés
    blancs: [[122, 632, 42, 13], [48, 385, 46, 16], [48, 545, 46, 16]],
    champs: [
      { k: "checks", key: "options", map: { "Première installation": { x: 33, y: 321 }, "12 premières semaines": { x: 33, y: 352 }, "Après les 12 premières semaines": { x: 30, y: 499 } } },
      { k: "phrase", modele: "{jours7_avant} jours/7.", pos: { x: 48, y: 396 }, size: 11 },
      { k: "phrase", modele: "{jours7_apres} jours/7.", pos: { x: 48, y: 556 }, size: 11 },
